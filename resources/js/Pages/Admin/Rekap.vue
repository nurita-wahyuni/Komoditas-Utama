...
const selectedKategoriName = computed(() => {
    return props.kategori_kapal.find(k => k.slug === selectedKategori.value)?.nama || '';
});
...
<template>
    <Head title="Rekap Data Operasional" />

    <BpsLayout>
        <div class="flex justify-between items-start mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Rekap Data Operasional</h1>
                <p class="text-gray-500 mt-1">Laporan operasional per kategori periode {{ selectedMonthName }} {{ selectedYear }}</p>
            </div>
            <div class="flex space-x-3">
                <button class="flex items-center space-x-2 px-4 py-2 bg-white border border-emerald-500 text-emerald-600 rounded-lg hover:bg-emerald-50 transition-colors shadow-sm">
                    <span>Excel</span>
                </button>
                <button class="flex items-center space-x-2 px-6 py-2 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-colors shadow-lg">
                    <span>Cetak PDF</span>
                </button>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div class="bg-blue-50 p-8 rounded-2xl border border-blue-100 flex flex-col items-center justify-center text-center shadow-sm">
                    <p class="text-xs font-bold text-blue-400 uppercase tracking-widest mb-2">Total Unit</p>
                ...
                <div class="bg-indigo-50 p-8 rounded-2xl border border-indigo-100 flex flex-col items-center justify-center text-center shadow-sm">
                    <p class="text-xs font-bold text-indigo-400 uppercase tracking-widest mb-2">Total Bongkar</p>
                ...
                <div class="bg-purple-50 p-8 rounded-2xl border border-purple-100 flex flex-col items-center justify-center text-center shadow-sm">
                    <p class="text-xs font-bold text-purple-400 uppercase tracking-widest mb-2">Total Muat</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-100 flex justify-between items-center">
                        <h4 class="font-bold text-blue-800">Kegiatan Bongkar</h4>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <tr v-if="!bongkar_data || bongkar_data.length === 0">
                                    <td colspan="3" class="px-6 py-8 text-center text-gray-400 text-sm">Tidak ada data bongkar.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-100 flex justify-between items-center">
                        <h4 class="font-bold text-emerald-800">Kegiatan Muat</h4>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <tr v-if="!muat_data || muat_data.length === 0">
                                    <td colspan="3" class="px-6 py-8 text-center text-gray-400 text-sm">Tidak ada data muat.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
