...
import { getRekapEntries } from "../../../services/api";
...
const RekapDataEntries = () => {
  ...
  // Initialize dates based on selectedMonth and selectedYear
  useEffect(() => {
    // Start of month: Year-Month-01
    const start = new Date(selectedYear, selectedMonth - 1, 1);
    // End of month: Year-Month-LastDay
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1 text-sm">
            Laporan operasional per kategori periode {MONTH_NAMES[selectedMonth - 1]} {selectedYear}
          </p>
        </div>
      ...
      <div className="card p-1">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 p-4 border-b border-slate-100">
          {/* Tabs - Now side by side with filter */}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="border border-slate-200 rounded-xl overflow-hidden">
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-slate-50">
                          {Object.entries(data.bongkar).map(([key, details]) => (
                    ...
                    <div className="border border-slate-200 rounded-xl overflow-hidden">
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-slate-50">
                          {Object.entries(data.muat).map(([key, details]) => (
                            <tr key={key} className="hover:bg-slate-50/50">
                              <td className="px-6 py-3 font-medium text-slate-700">
                                {details.label || key}
                              </td>
